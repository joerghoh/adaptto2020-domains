...
public class LanguageSiteTest {
    ...
    public void testSingleNodesAsLanguageNode() {
        ...
        assertNotNull(ls);
        assertEquals("/content/us/en",((LanguageSiteImpl)ls).getResource().getPath());
    ...
    public void testSingleNodesWithJcrLanguageAsLanguageNode() {
        ...
        LanguageSite ls = p.adaptTo(LanguageSite.class);
        assertNotNull(ls);
        assertEquals("/content/us/es",((LanguageSiteImpl)ls).getResource().getPath());
    ...
    public void testPagesAsLanguageNode() {
        ...
        assertNotNull(ls);
        assertEquals("/content/ch/de",((LanguageSiteImpl)ls).getResource().getPath());
    ...
    public void testCallOnLanguageSiteRoot() {
        ...
        assertNotNull(lsc);
        assertEquals("/content/ch/de",((LanguageSiteImpl)lsc).getResource().getPath());
